package com.factory.manual.util.TipDialog;
    ...
    public static class Builder {
        ...
        public TipDialog create() {
            ...
            if (mCurrentIconType == ICON_TYPE_LOADING) {
                ...
                loadingView.setSize(AppUtil.dp2px(mContext, 32));
            ...
            if (mTipWord != null && mTipWord.length() > 0) {
                ...
                if (mCurrentIconType != ICON_TYPE_NOTHING) {               tipViewLP.topMargin = AppUtil.dp2px(mContext, 12);
                }
